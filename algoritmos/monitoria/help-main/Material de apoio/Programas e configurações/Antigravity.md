# Passos para instalação do Antigravity IDE

## Oque é?

O Antigravity é uma IDE, basicamente um programa central que junta diversas ferramentas/extensoes que serve para compilar e criar softwares de diversas linguagens. É igual o vs code, so muda alguns detalhes de contas e algumas ferramentas. Cuidado, tem dois antigravitys principais um para IA e outro para IDE. O antigravity IDE é baseado no visual studio code, logo é bem parecido com ele.

## Passos de instalação

1. Acesse o link <https://antigravity.google/download> e arraste para baixo procurando o nome "Antigravity IDE" selecione o seu tipo de sistema operacional e baixe.
...
5. Seu Antigravity esta pronto para uso, mas deve ser instalado ainda as extensões e uns softwares por fora dependendo da linguagem ou frame work que deseja utilizar, normalmente o próprio Antigravity te ajuda nisso. Mas para programa em C olhe o arquivo C.md para ver os passos seguintes.
